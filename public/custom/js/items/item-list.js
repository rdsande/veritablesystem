$(function() {
    ...
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            columns: [
                ...
                {data: 'sku', name: 'sku', visible:itemSettings.sku==1?true:false},
    ...
    */
    ...
    $(document).on("change", '#brand_id, #item_category_id, #is_service, #user_id, #warehouse_id', function function_name() {
        loadDatatables();
    });
