<li class="nav-item dropdown dropdown-app">
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-0 cu-w-500-px">
                                    <div class="">
                                         ...
                                         <div class="col">
                                              <a href="{{ route('sale.return.create') }}">
                                                <div class="app-box d-flex align-items-center">
                                                  ...
                                                  <div class="app-name">
                                                    <p class="mb-0 fs-6">{{ __('sale.return.return') }}</p>
                                                  </div>
                                                </div>
                                              </a>
                                        </div>
                                         ...
                                         <div class="col">
                                              <a href="{{ route('purchase.return.create') }}">
                                                <div class="app-box d-flex align-items-center">
                                                  ...
                                                  <div class="app-name">
                                                    <p class="mb-0 fs-6">{{ __('purchase.return.return') }}</p>
                                                  </div>
                                                </div>
                                              </a>
                                        </div>
                                         ...
                                         <div class="col">
                                              <a href="{{ route('item.create') }}">
                                                <div class="app-box d-flex align-items-center">
                                                  ...
                                                  <div class="app-name">
                                                    <p class="mb-0 fs-6">{{ __('item.create') }}</p>
                                                  </div>
                                                </div>
                                              </a>
                                        </div>
                                         ...
                                         <div class="col">
                                              <a href="{{ route('party.create', ['partyType' => 'customer']) }}">
                                                <div class="app-box d-flex align-items-center">
                                                  ...
                                                  <div class="app-name">
                                                    <p class="mb-0 fs-6">{{ __('customer.create_customer') }}</p>
                                                  </div>
                                                </div>
                                              </a>
                                        </div>
                                         ...
                                         <div class="col">
                                              <a href="{{ route('party.create', ['partyType' => 'supplier']) }}">
                                                <div class="app-box d-flex align-items-center">
                                                  ...
                                                  <div class="app-name">
                                                    <p class="mb-0 fs-6">{{ __('supplier.create_supplier') }}</p>
                                                  </div>
                                                </div>
                                              </a>
                                        </div>
