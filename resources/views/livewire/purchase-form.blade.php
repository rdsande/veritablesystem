<div>
    <table class="table table-bordered" id="products_table">
        <thead class="thead-dark">
            <tr>
                <th class="align-middle">Spare/Product</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="align-middle">
                    ...
                    <select wire:model.live="invoiceProducts.{{$index}}.product_id"
                        ...
                        <option value="" class="text-center">-- choose spare/product --</option>
            ...
            <tr>
                ...
                <td width="150" class="align-middle text-center">
                    <input wire:model.blur="taxes" type="number" id="taxes" class="form-control w-75 d-inline" min="0"
                        max="100">
                    %
